...
export default function CompressVideoClient() {
  ...
  const compress = async () => {
    ...
    try {
      ...
      console.error(e);
      setError(
        "Video compression failed. FFmpeg WASM requires a modern browser with SharedArrayBuffer support."
      );
      setStatus("error");
    }
  };
      ...
      {status === "processing" && (
        <div className="rounded-xl border border-slate-200 bg-white p-8">
          <p className="mb-4 text-center font-medium text-slate-700">
            Compressing video… this may take a few minutes for large files.
          </p>
