...
const values = [
  {
    ...
    title: "Speed First",
    description:
      "Every tool is built to run instantly in your browser. No waiting, no server queues — just results.",
  ...
  },
  {
    ...
    description:
      "Your files never leave your device when processed in-browser. What you upload stays yours.",
  ...
  },
  {
    ...
    description:
      "No account. No software. No expertise required. If you have a browser, you have our tools.",
  ...
  },
  {
    ...
    description:
      "We obsess over output quality. Every tool is tested to produce the best possible result.",
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-100 px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-slate-900 sm:text-6xl lg:text-5xl leading-[1.1]">
            Tools that work{" "}
          ...
          <p className="mt-6 mx-auto max-w-2xl text-lg text-slate-500 leading-relaxed">
            ...
            fast, and private. No bloat. No accounts. Just results — right in
            your browser.
          </p>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v) => (
              ...
              >
                ...
                <h3 className="font-medium text-slate-900 mb-2">{v.title}</h3>
