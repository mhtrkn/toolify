    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="border-t border-slate-200 bg-white px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-xl font-bold text-slate-900">AI-Powered OCR Text Recognition</h2>
          <p className="mt-3 text-slate-600">
            Extract text from scanned documents, photos of receipts, screenshots,
            or any image file. Our AI-powered OCR engine delivers fast and accurate
            results with support for over 100 languages.
          </p>
        </div>
      </section>
