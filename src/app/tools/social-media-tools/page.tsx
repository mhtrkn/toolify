      ...
      <section className="border-t border-slate-100 bg-white px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-3 text-slate-600">
            ...
            Use the{" "}
            <Link
              href="/tools/social-media-tools/youtube-tag-generator"
            ...
            to improve SEO, the{" "}
            <Link
              href="/tools/social-media-tools/instagram-hashtag-generator"
              className="text-rose-600 hover:underline"
            >
              Instagram Hashtag Generator
            </Link>{" "}
            ...
            <Link
              href="/tools/social-media-tools/fancy-text-generator"
              className="text-rose-600 hover:underline"
            >
              Fancy Text Generator
            </Link>{" "}
