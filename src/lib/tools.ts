...
export const TOOLS: Tool[] = [
  ...
  // OCR Tools
  {
    ...
    icon: "🔍",
    keywords: ["ocr image to text online free", "extract text from image", "image to text converter ocr", "jpg to text extractor online", "scan image to text free", "photo to text converter", "online ocr no signup", "ai image text recognition", "convert picture to text free", "handwriting ocr online free"],
    popular: true,
  ...
  },
  {
    ...
    categoryName: "OCR Tools",
    icon: "📋",
    keywords: ["pdf to text converter free", "extract text from pdf online", "pdf text extractor", "scanned pdf to text ocr", "copy text from pdf free", "pdf to txt converter online", "pdf text recognition free", "convert pdf to plain text", "pdf to text no software", "pdf ocr text extractor free"],
    acceptedFormats: [".pdf"],
    outputFormat: "TXT",
  },
];
